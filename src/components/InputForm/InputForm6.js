...
class Input extends Component {
  ...
  onSubmit = () => {
    let n = this.state.I * Math.pow(Number(this.state.I) + 1, this.state.T);
    let d = Number(Math.pow(Number(this.state.I) + 1, this.state.T)) - 1;
    let A = (this.state.P * n) / d;
  ...
  render() {
    ...
    return (
      <div>
        <div className="k">
          <div className="con">
            <h1>Equal Payment Series Capital Recovery</h1>
